        ...
        new()
        {
            ...
            [
                ...
                Spec("RippleThickness", "Ripple 线宽", "\uEFFF", SettingValueKind.Double, 0.5, 40, "0.##",
                    "环形或方框 Ripple 的线条粗细。"),
                Spec("HanabiConstraintEnabled", "限制花火扩散", "\uEFFF", SettingValueKind.Bool,
                    "以 ClassIsland 为圆心创建圆形裁剪遮罩，避免花火扩张至整个屏幕。"),
                Spec("CountdownArrowsEnabled", "倒计时箭头", "\uE4C4", SettingValueKind.Bool,
                    "即将上课时显示箭头滑动效果。"),
                Spec("CountdownArrowColor", "箭头颜色", "\uE4C4", SettingValueKind.String,
                    "支持透明度的倒计时箭头颜色。"),
                Spec("CountdownArrowCount", "箭头组数", "\uE4C4", SettingValueKind.Int, 2, 24, "0",
                    "每组显示为一对 >> 箭头。"),
                Spec("CountdownArrowSpeed", "滑动速度", "\uE4C4", SettingValueKind.Double, 0.1, 12, "0.##",
                    "倒计时箭头的移动速度。"),
                Spec("CountdownArrowThickness", "箭头线宽", "\uE4C4", SettingValueKind.Double, 0.5, 8, "0.##",
                    "倒计时箭头的线条粗细。"),
            ]
        },
        new()
