...
### 换皮肤
- **背景**：纯色、渐变色随便换，还能叠纹理，甚至还有**动态频谱**（底色/边框/阴影同样适配「分体主界面」）
...
- **提醒文字不显示**：可能是显卡过老，我已尽最大努力修复此问题，可以查看[临时解决方案](https://github.com/BSOD-MEMZ/ClassIslandInjector/issues/1)。（提醒预览界面没有文字是正常的，本来预览就没有任何文字）
- **套索或选框工具不工作**：尝试在图层面板栅格化图层。
- **画笔工具不工作**：在图层面板新建画布图层。
