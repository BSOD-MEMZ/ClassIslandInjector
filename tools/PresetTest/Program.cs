...
Check("无预设 Scale=1", 1.0, noPreset.Scale);
...
withProtection.Scale = 1.3;
withProtection.Rotation = 20;
withProtection.OffsetX = 50;
withProtection.OffsetY = -30;
withProtection.CornerRadius = 12;
withProtection.CustomSizeEnabled = true;
withProtection.MainWindowWidth = 500;
withProtection.MainWindowHeight = 150;
...
Check("样式预设保护 Scale", 1.3, withProtection.Scale);
...
Check("样式预设保护 CustomSizeEnabled", true, withProtection.CustomSizeEnabled);
